    ...
    <div class="col-sm-12">
      <div class="card text-left">
        ...
        <div class="card-body">
         ...
         <form class="form-horizontal" method="POST" action="act_perso2.php" autocomplete="off" style="border-collapse: separate; border-spacing: 10px 5px;">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
             <div class="col-sm-offset-2 col-sm-10">
              <a href="listadoact.php" class="btn btn-warning">Regresar</a>
