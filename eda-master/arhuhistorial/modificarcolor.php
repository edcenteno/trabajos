         ...
         <form class="form-horizontal" method="POST" action="modif_color2.php" autocomplete="off" style="border-collapse: separate; border-spacing: 10px 5px;">
           ...
           <!--  <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="fecha_fab_veh" class="form-control" id="fecha_fab_veh" placeholder="Año de Fabricación del Vehiculo"  value="<?php echo $rowvehiculo['fecha_fab_veh'] ?>">
            </div>
            </div>
          </div>
