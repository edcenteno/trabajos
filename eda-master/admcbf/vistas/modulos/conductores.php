...
$(document).ready(function(){
  $('#nuevoPlaca').on('paste', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
  
  $("#nuevoPlaca").on('copy', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
})
...
$(document).ready(function(){
  $('#nuevoNombre').on('paste', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
  
  $("#nuevoNombre").on('copy', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
})
...
$(document).ready(function(){
  $('#nuevoApellido').on('paste', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
  
  $("#nuevoApellido").on('copy', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
})
...
$(document).ready(function(){
  $('#nuevoDni').on('paste', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
  
  $("#nuevoDni").on('copy', function(e){
    e.preventDefault();
    //alert('Esta acción está prohibida');
  })
})
