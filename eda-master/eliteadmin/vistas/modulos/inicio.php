...
<div class="col-lg-6 col-md-6">
    <!-- <div class="card">
        <div class="card-body">
            <h4 class="card-title">Gráfica de Aptos y No Aptos </h4>
            <div id="m-piechart" style="width:100%; height:308px"></div>
            <center>
                <ul class="list-inline m-t-20">
                    <li>
                        <h6 class="text-muted"><i class="fa fa-circle m-r-5 text-purple"></i>Aptos</h6> </li>
                    <li>
                        <h6 class="text-muted"><i class="fa fa-circle m-r-5 text-danger"></i>No Aptos</h6> </li>
                    </ul>
            </center>
        </div>
    </div> -->
