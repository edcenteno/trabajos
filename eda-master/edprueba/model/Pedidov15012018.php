<?php
	...
	from detalle_pedido where idpedido = $idpedido";
        ...
        public function TotalPedidoImpuesto($idpedido, $IgvPorcentaje){
			global $conexion;
			$sql = "select sum((cantidad * precio_venta) - descuento) as Total , round( (sum((cantidad * precio_venta) - descuento) *$IgvPorcentaje)/(100+$IgvPorcentaje),2) as IgvTotal, round( sum((cantidad * precio_venta) - descuento) - (sum((cantidad * precio_venta) - descuento) *$IgvPorcentaje)/(100+$IgvPorcentaje),2) as SubTotal from detalle_pedido where idpedido = $idpedido";
			$query = $conexion->query($sql);
			return $query;
		}
