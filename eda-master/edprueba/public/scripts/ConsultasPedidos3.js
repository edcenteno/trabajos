...
function init(){
	...
	$("#cboFechaDesdeStock").change(ListadoStockArticulos);
	$("#cboFechaHastaStock").change(ListadoStockArticulos);

	$("#cboFechaDesdeKar").change(ListadoKardexValorizado);
	$("#cboFechaHastaKar").change(ListadoKardexValorizado);


	$("#cboFechaDesde").change(ListadoComprasFechas);
	$("#cboFechaHasta").change(ListadoComprasFechas);
	
	$("#cboFechaDesde").change(ListadoPedidoFechas);
	$("#cboFechaHasta").change(ListadoPedidoFechas);
	...
	function ListadoKardexValorizado(){ 
		...
		var fecha_desde = $("#cboFechaDesdeKar").val(), fecha_hasta = $("#cboFechaHastaKar").val();
	...
	function ListadoStockArticulos(){
		...
		var idsucursal = $("#txtIdSucursal").val();
		var fecha_desde = $("#cboFechaDesdeStock").val(), fecha_hasta = $("#cboFechaHastaStock").val();
	...
	if($("#cboFechaDesde").val() != "" && $("#cboFechaHasta").val() != ""){
			...
			{   "aProcessing": true,
	        	...
	        	"aoColumns":[        	     	
		        	...
		        	{
		        		url: './ajax/ConsultasPedidoAjax.php?op=listPedidoFechas',
						type : "get",
						data:{fecha_desde: fecha_desde, fecha_hasta: fecha_hasta, idsucursal: idsucursal},
						dataType : "json",
