...
function init() {
   ...
   // $("#cboTipoComprobanteIng").change(VerNumSerie);
    ...
    function Agregar(){
        ...
        var codigo_barra = document.getElementsByName("txtCodigoBarra");
...
function ListadoIngresos(){ 
    ...
    function AgregarDetalle(idart, nombre, codigo, serie, descripcion, stock_ing, stock_act, p_compra, p_ventaD, p_ventaP, pos) {
        ...
        for (var i = 1; i <= cant; i++) {
            ...
            if (serie != null) {
                console.log("xxx->>>"+elementos[pos][3]);
    ...
    function Agregar(id, art,art, descripcion, codigo_barra){
        AgregarDetalleCarrito(id, art, art, descripcion, codigo_barra, "1", "1", "1", "1", "1");
    }