...
$pdf->addClientAdresse(utf8_decode($reg_cli->nombre),$reg_cli->doc.": ".$reg_cli->num_documento, "Domicilio: ".utf8_decode($reg_cli->direccion_calle)." - ".utf8_decode($reg_cli->direccion_departamento),"Email: ".$reg_cli->email,"Telefono: ".$reg_cli->telefono);
