...
$pdf->AddPage();
$pdf->addSociete( utf8_decode($reg_cli->razon_social), utf8_decode("$reg_cli->num_sucursal")."\n" .
                  "DIRECCION DE PARTIDA: ".utf8_decode("$reg_cli->direccion")."\n".
                  "CONTACTO DEL EMISOR: $reg_cli->email_suc ","../$f","$extension");
...
$pdf->addClientAdresse(utf8_decode($reg_cli->nombre),$reg_cli->doc.": ".$reg_cli->num_documento, "DIRECCION DE LLEGADA: ".utf8_decode($reg_cli->direccion_calle)." - ".utf8_decode($reg_cli->direccion_departamento),"MAIL DEL DESTINATARIO: ".$reg_cli->email,"TELEFONO DEL DESTINATARIO: ".$reg_cli->telefono);
