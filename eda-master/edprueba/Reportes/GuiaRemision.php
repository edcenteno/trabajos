...
function addDate( $date )
{
	...
	$y2  = $y1 ;
	$mid = $y1 + ($y2 / 2);
	//s$this->RoundedRect($r1, $y1, ($r2 - $r1), $y2, 3.5, 'D');
...
function addClientAdresse( $cliente,$domicilio,$num_documento,$email,$telefono )
{
	...
	$this->SetXY( $r1, $y1+20);
//	$this->MultiCell( 150, 16, $email);
	$this->SetXY( $r1, $y1+25);
//	$this->MultiCell( 150, 12, $telefono);
}

function addClientasociado( $cliente,$domicilio,$num_documento,$email,$telefono )
{
	$r1     = $this->w - 200;
	$r2     = $r1 + 68;
	$y1     = 40;
