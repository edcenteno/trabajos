<?php
	...
	from detalle_pedido where idpedido = $idpedido";
		...
		public function GetDetallePedido($idpedido){
			global $conexion;
			$sql = "select a.nombre as articulo, dg.codigo, v.serie_comprobante, a.descripcion, dg.serie, dp.*
			from venta v pedido p inner join detalle_pedido dp on p.idpedido = dp.idpedido
