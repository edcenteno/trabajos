	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 3px solid #5b9bd4; background-color:white; width:540px" align="center">
				...
				DATOS DEL POSTULANTE: <b> $value[nombre] </b>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:130px; text-align:center"><b></b></td>
...
$bloqueencabezadorecord = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="solid #666; background-color:white; width:150px; text-align:center"><b>$value[nombre]</b></td>
