...
*/
	...
	$(document).ready(function() {
    var table = $('.tablaConductoresProvincia').DataTable( {
    "ajax": "ajax/datatable-conductoresprovincia.ajax.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
    "order": [[0, "desc"]],
...
*/
    ...
    $(document).ready(function() {
    $('.tablaConductoresActualizados').DataTable( {
    "ajax": "ajax/datatable-conductoresact.ajax.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
    "order": [[0, "desc"]],
	...
	$(document).ready(function() {
    $('.tablaConductoresCabify').DataTable( {
	...
	$(document).ready(function() {
    $('.tablaConductoresEasy').DataTable( {
...
$(document).ready(function() {
    $('.tablaConductoresSoat').DataTable( {
    ...
    "ajax": "ajax/datatable-conductoreshistorial.ajax.php",
    "deferRender": true,
	"retrieve": true,
	"processing": true,
    "order": [[0, "desc"]],
