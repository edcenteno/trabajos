...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Conductores EasyTaxi</h4>
        </div>
                ...
                <div class="card-body">
                    <!-- <button type="button" class="btn btn-info d-none d-lg-block m-l-15" data-toggle="modal" data-target="#modalAgregarConductor"><i class="fa fa-plus-circle"></i> Nuevo Conductor </button> -->
                      <div class="table-responsive m-t-20">
                        <table class="display nowrap table table-hover table-striped table-bordered dt-responsive tablaConductoresEasy" cellspacing="0" width="100%">
                            <thead>
                                <tr>
