...
class TablaConductor{
  ...
  public function mostrarTabla(){
    ...
    $conductores = ControladorConductor::ctrMostrarConductorHistorial($item, $valor);
    ...
    echo '{
            ...
            for($i = 0; $i < count($conductores)-1; $i++){
                 ...
                 $vermas= "<div class='btn-group'><a class='btn btn-success btnvermas' href='index.php?ruta=vermashistorial&idconductor=".$conductores[$i]["dni"]."' target='_blank'>ver<i class='fa fa-fw fa-plus'></i></a></div>";
           ...
           echo'[
                  ...
                  "'.$conductores[count($conductores)-1]["fecha_revision"].'",
