<?php
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?dni=".$aRow['dni']."'><button type='button' class='btn btn-outline-primary'><i class='fa fa-pencil'></i></button></a>";


		$row[] = "<td><a href='#' data-href='eliminar.php?dni=".$aRow['dni']."' data-toggle='modal' data-target='#confirm-delete'><button type='button' class='btn btn-outline-danger'><i class='fa fa-trash-o'></i></button></a></td>";
