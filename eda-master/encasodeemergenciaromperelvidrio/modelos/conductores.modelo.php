...
class ModeloConductor{
	...
	CABIFY
	=============================================*/
	static public function mdlMostrarConductorhoyCabifsy($tabla, $item, $valor){
		$mes = date('Y-m');
		if($item != null){
		...
		static public function mdlMostrarCondusctoresmigradosmesanteriorcbf($tabla, $item2, $valor2){
			$mes = date('Y-m');
			$mesact = date("Y-m",strtotime($mes."- 1 month"));
		if($item2 != null){
