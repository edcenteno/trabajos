	...
	$.ajax({
      ...
      success:function(respuesta){
          ...
          if(modo == "sandbox"){
		   ...
		   $(".formPayu input[name='confirmationUrl']").attr("value", rutaOculta+"index.php?ruta=finalizar-compra-payu&payu=true&idUsuario="+idUsuario+"productos="+productos+"&cantidad="+cantidad+"&pago="+total);
