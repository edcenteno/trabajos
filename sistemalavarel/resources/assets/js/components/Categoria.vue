<template>
            ...
            :class="{'mostrar' : modal}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model = "descripcion" class="form-control" placeholder="Insertar descripción">
                                    </div>
                                </div>
                                <div v-if="errorCategoria" class="form-group row div-error">
